...
class SatParameters final :
 ...
 public:
  ...
  enum : int {
    ...
    kUseCumulativeInNoOverlap2DFieldNumber = 200,
  ...
  private:
  bool _internal_has_use_cumulative_in_no_overlap_2d() const;
  public:
  ...
  private:
  bool _internal_use_cumulative_in_no_overlap_2d() const;
  void _internal_set_use_cumulative_in_no_overlap_2d(bool value);
  public:
 ...
 private:
  ...
  bool use_cumulative_in_no_overlap_2d_;
...
// optional bool use_cumulative_in_no_overlap_2d = 200 [default = false];
inline bool SatParameters::_internal_has_use_cumulative_in_no_overlap_2d() const {
  bool value = (_has_bits_[1] & 0x00000400u) != 0;
  return value;
}
inline bool SatParameters::has_use_cumulative_in_no_overlap_2d() const {
  return _internal_has_use_cumulative_in_no_overlap_2d();
}
inline void SatParameters::clear_use_cumulative_in_no_overlap_2d() {
  use_cumulative_in_no_overlap_2d_ = false;
  _has_bits_[1] &= ~0x00000400u;
}
inline bool SatParameters::_internal_use_cumulative_in_no_overlap_2d() const {
  return use_cumulative_in_no_overlap_2d_;
}
inline bool SatParameters::use_cumulative_in_no_overlap_2d() const {
  // @@protoc_insertion_point(field_get:operations_research.sat.SatParameters.use_cumulative_in_no_overlap_2d)
  return _internal_use_cumulative_in_no_overlap_2d();
}
inline void SatParameters::_internal_set_use_cumulative_in_no_overlap_2d(bool value) {
  _has_bits_[1] |= 0x00000400u;
  use_cumulative_in_no_overlap_2d_ = value;
}
inline void SatParameters::set_use_cumulative_in_no_overlap_2d(bool value) {
  _internal_set_use_cumulative_in_no_overlap_2d(value);
  // @@protoc_insertion_point(field_set:operations_research.sat.SatParameters.use_cumulative_in_no_overlap_2d)
}
